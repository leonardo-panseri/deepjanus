...
class BeamNGMember(Member):
    ...
    def clone(self, name: str = None):
        ...
        res = BeamNGMember(list(self.road.control_nodes), list(self.road.nodes), self.road.num_spline_nodes,
                           RoadGenerationBoundary(self.generation_boundary.bbox.bounds), name)
    ...
    def to_dict(self) -> dict:
        return {
            ...
            'road_boundary': self.generation_boundary.bbox.bounds,
            'satisfy_requirements': self.satisfy_requirements
        }

    @classmethod
    def from_dict(cls, d: dict, name: str = None) -> 'BeamNGMember':
        road_bbox = RoadGenerationBoundary(d['road_boundary'])
